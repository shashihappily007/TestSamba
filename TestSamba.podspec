#
# Be sure to run `pod lib lint TestSamba.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'TestSamba'
  s.version          = '0.1.0'
  s.summary          = 'A short description of TestSamba.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'TestSamba/Classes/**/*'
  
  # s.resource_bundles = {
  #   'TestSamba' => ['TestSamba/Assets/*.png']
  # }
